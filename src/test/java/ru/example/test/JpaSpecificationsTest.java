...
import ru.example.repositories.ActualEntityRepository;
...
public class JpaSpecificationsTest {
    ...
    @Autowired
    private ActualEntityRepository actualEntityRepository;
    ...
    public void testChildExecution() {
        ...
        SearchCriteria criterion = new SearchCriteria(
                ...
                Arrays.asList(
                        ...
                        new SearchCriteria("children.id", SearchOperation.LESS, "3", null, null)
                ),
                JoinType.OR
        );
    ...
    public void checkGenerate() {
        ...
        businessId.setId("actualEntity");
        businessIdRepository.save(businessId);
        actualEntityRepository.save(actualEntity);
        actualEntityRepository.save(actualEntity1);
        actualEntityRepository.save(actualEntity2);
    }
}
